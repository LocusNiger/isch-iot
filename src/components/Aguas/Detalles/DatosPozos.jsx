  ...
  return (
    <>
      ...
      >
        ...
        <div className="collapse-title text-xl font-medium">Datos del pozo</div>
        <div className="collapse-content flex gap-8">
          <div className="flex flex-col">
            ...
            <p className="font-semibold">
              ...
              <span className="font-normal">
                {detail.idLora === null ? "-" : detail.idLora}
              </span>
            </p>
            <p className="font-semibold">
          ...
          <div className="flex flex-col">
            ...
            <p className="font-semibold">
              ...
              <span className="font-normal">
                {detail.idTempMotor === null
                  ? "-" || detail.idTempMotor === undefined
                  : detail.idTempMotor}{" "}
              </span>
            </p>
            <p className="font-semibold">
              ID velocidad de salida:{" "}
              <span className="font-normal">
                {detail.idVelSalida === null || detail.idVelSalida === undefined
                  ? "-"
                  : detail.idVelSalida}
              </span>
            </p>
